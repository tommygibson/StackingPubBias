####### Second stacking simulation
## selection function is by p-values
## fixed stepwise selection models
...
sim.moderate.big.15 <- list(stacked.summary, model.sums, weights, theta0, data.summary, funnel.plots, big_k)
names(sim.moderate.big.15) <- c("stacked", "models", "weights", "theta0", "data.summary", "funnel.plots", "big.k")
saveRDS(sim.moderate.big.15, file = here("R", "Results", "sim.moderate.big.15.rds"))
...
sim.moderate.big.30 <- list(stacked.summary, model.sums, weights, theta0, data.summary, funnel.plots, big_k)
names(sim.moderate.big.30) <- c("stacked", "models", "weights", "theta0", "data.summary", "funnel.plots", "big.k")
saveRDS(sim.moderate.big.30, file = here("R", "Results", "sim.moderate.big.30.rds"))
...
sim.moderate.big.60 <- list(stacked.summary, model.sums, weights, theta0, data.summary, funnel.plots, big_k)
names(sim.moderate.big.60) <- c("stacked", "models", "weights", "theta0", "data.summary", "funnel.plots", "big.k")
saveRDS(sim.moderate.big.60, file = here("R", "Results", "sim.moderate.big.60.rds"))
