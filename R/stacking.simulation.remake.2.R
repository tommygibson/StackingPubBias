...
sim.extreme.big.15 <- list(stacked.summary, model.sums, weights, theta0, data.summary, funnel.plots, big_k)
names(sim.extreme.big.15) <- c("stacked", "models", "weights", "theta0", "data.summary", "funnel.plots", "big.k")
saveRDS(sim.extreme.big.15, file = here("R", "Results", "sim.extreme.big.15.rds"))
...
sim.extreme.big.60 <- list(stacked.summary, model.sums, weights, theta0, data.summary, funnel.plots, big_k)
names(sim.extreme.big.60) <- c("stacked", "models", "weights", "theta0", "data.summary", "funnel.plots", "big.k")
saveRDS(sim.extreme.big.60, file = here("R", "Results", "sim.extreme.big.60.rds"))
