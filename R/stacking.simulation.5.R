...
sim.results.5 <- list(stacked.summary, model.sums, weights, theta0, data.summary, funnel.plots, big_k)
names(sim.results.5) <- c("stacked", "models", "weights", "theta0", "data.summary", "funnel.plots", "big.k")
saveRDS(sim.results.5, file = here("R", "Results", "sim.results.5.rds"))
